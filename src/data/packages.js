...
export const packages = [
  // GROUP PACKAGES
  {
    ...
    includes: ["AC Travel", "Hotel Stay", "Breakfast", "Sightseeing", "Local Guide"],
  ...
  },
  {
    ...
    includes: ["AC Travel", "Hotel Stay", "Breakfast", "Sightseeing", "Local Guide"],
    locations: ["Kochi", "Athirappilly", "Munnar", "Alappuzha"],
    fullDescription: "4 days of Kerala magic covering waterfalls, tea gardens, and backwaters.",
    isKerala: true,
    packageType: "group"
  },
  {
    ...
    includes: ["AC Travel", "Premium Stay", "Breakfast", "Sightseeing", "Local Guide", "Houseboat"],
  ...
  },
  {
    ...
    includes: ["AC Travel", "Premium Stay", "Breakfast", "Sightseeing", "Local Guide", "Houseboat", "Special Activities"],
    locations: ["Kochi", "Athirappilly", "Munnar", "Thekkady", "Alappuzha", "Kovalam", "Trivandrum"],
  ...
  // HONEYMOON PACKAGES
  {
    ...
    oldPrice: 12999,
    couplePrice: 32999,
    oldCouplePrice: 25999,
    duration: "3 Days / 2 Nights",
    badge: "Romantic",
    shortDescription: "Perfect romantic hill + backwater experience. Kochi → Munnar → Alappuzha → Kochi 🌄🛶",
    image: "https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=800&q=80",
    includes: ["Luxury Stay", "Candlelight Dinner", "Houseboat", "Breakfast", "Romantic Decor", "Private Transfers"],
  ...
  },
  {
    ...
    duration: "3 Days / 2 Nights",
    badge: "Romantic",
    shortDescription: "Beach + Backwaters combo. Kochi → Alappuzha → Varkala 🌊",
    image: "https://images.unsplash.com/photo-1537953773345-d172ccf13cf1?w=800&q=80",
    includes: ["Beach Resort", "Candlelight Dinner", "Houseboat", "Breakfast", "Romantic Decor", "Private Transfers"],
    locations: ["Kochi", "Alappuzha", "Varkala"],
    fullDescription: "Perfect blend of backwaters and beaches for couples seeking romance and relaxation.",
    isKerala: true,
    packageType: "honeymoon",
    route: "Kochi → Alappuzha → Varkala"
  },
  {
    id: 8,
    ...
    includes: ["Premium Stay", "Candlelight Dinner", "Breakfast", "Romantic Decor", "Private Transfers", "Sunset Cruise"],
